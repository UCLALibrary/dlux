...
from dlux.fields import MappedArrayField, MappedCharField, MappedForeignKey
...
class UnsortedMetadata(models.Model):
    ...
    resource_type = MappedCharField(
        ...
        choices={
            ...
            "http://id.loc.gov/vocabulary/resourceTypes/aun": "sound recording-nonmusical",
