"""Type stubs for django-jsonform.

Based on:
https://github.com/sbdchd/django-types/django-stubs/contrib/postgres/fields/array.pyi
"""
...
_ValidatorCallable = Any
_ErrorMessagesMapping = Any
_StrOrPromise = Any
_V = TypeVar("_V", bound=Any | None)

class ArrayField(Field[_V | Combinable, _V], Generic[_V]):
